...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	speedMsc := w.meanSpeed() * KmHInMsec
	heightMt := w.Height / CmInM
	return ((CaloriesWeightMultiplier * w.Weight) + (math.Pow(speedMsc, 2) / heightMt * CaloriesSpeedHeightMultiplier * w.Weight)) * w.Duration.Hours() * MinInHours
}
